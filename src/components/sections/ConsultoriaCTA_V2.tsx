...
export default function ConsultoriaCTA_V2() {
  ...
  return (
    ...
    >
      {/* Version label */}
      <div className="max-w-[1100px] mx-auto mb-4 mt-16">
        <span className="text-xs font-mono uppercase tracking-widest px-3 py-1.5 rounded-full" style={{ background: "rgba(117,83,255,0.15)", color: "#7553ff" }}>
          Versão 0 — Simplificada com Pills
        </span>
      </div>

      <div
        className="relative max-w-[1100px] mx-auto my-4 rounded-2xl overflow-hidden"
